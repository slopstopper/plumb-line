...
Suites: JS `npm ci && npx vitest run` → 275/275; Python `python3 -m pytest` → 212/212 (reproduced 2026-09-25).
...
The suite totals differ (275 JS vs 212 Python) partly because JS carries a
