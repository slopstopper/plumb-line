...
Suites: JS `npm ci && npx vitest run` → 281/281; Python `python3 -m pytest` → 216/216 (reproduced 2026-09-25).
...
The suite totals differ (281 JS vs 216 Python) partly because JS carries a
