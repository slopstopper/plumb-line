...
| `AGENTS.md` | [needs-review, advisory] no source-truth layer or layer map is declared for the repo itself, so P1/P2 can only be checked partially | P6 — Maturity vocabulary | **deferred** → [#434](https://github.com/slopstopper/plumb-line/issues/434); **drafted in v0.11.3**: ADR-0018 (Proposed, awaiting owner acceptance) |
