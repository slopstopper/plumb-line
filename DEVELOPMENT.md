...
Python CI test deps: `pip install pytest import-linter`. Node 22 + 24; Python 3.11, 3.12 and 3.13 in CI. Floors: Node 22 (`engines` in `primitives/js/package.json`), Python 3.11 (EOL policy in [SUPPORT.md](SUPPORT.md)).
